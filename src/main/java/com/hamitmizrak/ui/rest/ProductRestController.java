...
public class ProductRestController {
    ...
    //EKLEME
    // http://localhost:8081/docker/v1/create/product
    ...
    // SELECT
    // http://localhost:8081/docker/v1/list/product
    ...
    //BULMA
    // http://localhost:8081/docker/v1/find/product/1
    ...
    // SILME
    // http://localhost:8081/docker/v1/delete/product/1
